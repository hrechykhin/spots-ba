import type { CafeDetail, CafeFilters, CafeListItem, CafeMapPin } from '../types/cafe'
...
export function fetchCafes(filters: CafeFilters = {}): Promise<CafeListItem[]> {
  ...
  return apiFetch<CafeListItem[]>(`/cafes${qs ? `?${qs}` : ''}`)
}
